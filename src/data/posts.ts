...
export const posts: Post[] = [
  ...
  },
  {
    ...
    steps: [
      { title: "Squeegee glass doors after every shower", body: "Keep a squeegee hanging inside the shower and run it over the glass door and tile walls right after you turn off the water. This 30-second habit removes 90% of the water that causes hard-water spots and soap scum. It's the single easiest way to keep a shower looking clean between deep cleans. Start from the top and pull downward in overlapping strokes. A good squeegee costs under ten dollars and saves you from scrubbing hardened mineral deposits every weekend." },
      { title: "Spray daily shower cleaner on wet surfaces", body: "After squeegeeing, mist a daily shower spray over walls and the door. These light-duty formulas prevent mineral and soap buildup so it never gets a chance to harden. You don't need to rinse or wipe — just spray and walk away. It adds five seconds to your routine and saves hours later. You can make your own by mixing one part vinegar, one part water, and a few drops of dish soap in a spray bottle. Store-bought or homemade, the consistent daily use is what matters most." },
      { title: "Deep-clean grout with a paste", body: "Mix baking soda and water into a thick paste and apply to grout lines using an old toothbrush. Scrub in short strokes, let it sit for 10 minutes, then rinse. For stubborn mildew, swap the water for hydrogen peroxide. Clean grout lines make even old tile look brand new. Focus on floor grout first since it collects the most soap residue and discoloration. If your grout is sealed, this method is safe and won't strip the sealant. Unsealed grout benefits from a sealant application after deep cleaning." },
      { title: "Dissolve soap scum with vinegar", body: "Heat one cup of white vinegar in the microwave for 30 seconds, then mix with one cup of Dawn dish soap in a spray bottle. Spray it on soap scum, wait 15 minutes, and wipe with a sponge. The warm vinegar cuts through buildup that regular bathroom cleaner struggles with. This combination is widely considered the most effective DIY soap scum remover. The soap helps the vinegar cling to vertical surfaces instead of running off, giving the acid more contact time to dissolve the minerals." },
      { title: "Descale the showerhead", body: "Unscrew the showerhead or tie a bag of vinegar around it so it's submerged. Let it soak overnight. In the morning, scrub the nozzle holes with an old toothbrush and run hot water for a minute. You'll notice stronger, more even water pressure immediately. Hard water areas should do this monthly since calcium builds up faster. If individual nozzle holes are still clogged, push a toothpick into each one to clear the mineral plug that vinegar didn't fully dissolve." },
      { title: "Clean shower door tracks", body: "Pour vinegar into the door tracks and let it fizz for 10 minutes. Use a small brush or old toothbrush to scrub out the grime that collects in the grooves. Rinse by pouring water along the track, then dry with a cloth. Dirty tracks are one of the most overlooked spots in any bathroom. They trap mold, hair, and soap residue that eventually causes the door to stick. Clean tracks also prevent water from leaking onto the bathroom floor during showers." },
      { title: "Wash the shower curtain and liner", body: "Throw fabric curtains and plastic liners in the washing machine on a gentle cycle with two towels, warm water, and half a cup of baking soda. Hang to dry immediately. This removes mildew, soap residue, and that slimy feel at the bottom of liners without scrubbing by hand. The towels act as gentle agitators to help scrub the curtain during the wash cycle. Do this once a month and your curtain will last much longer before needing replacement." },
      { title: "Scrub the shower floor and drain", body: "Sprinkle baking soda on the shower floor and scrub with a stiff brush in circular motions. Pull out the drain cover and remove hair and buildup — a bent wire or drain snake works well. Rinse everything with hot water. A clean drain prevents standing water and mildew odors. If water pools in your shower instead of draining quickly, hair is almost always the culprit. A monthly drain cleanout prevents clogs from ever reaching the point where you need professional plumbing help." },
      { title: "Clean fixtures and handles", body: "Spray bathroom cleaner on chrome or brushed-nickel fixtures and wipe with a microfiber cloth. For water spots, wrap fixtures in a vinegar-soaked cloth for five minutes, then buff dry. Shiny fixtures are the detail that makes a bathroom look hotel-level polished. Include towel bars, the toilet handle, and the shower door handle in your fixture round. These are high-touch surfaces that collect both water spots and germs, so cleaning them serves both aesthetic and hygiene purposes." },
      { title: "Ventilate properly after cleaning", body: "Run the bathroom exhaust fan for at least 20 minutes after your shower and after cleaning. If you don't have a fan, open a window. Moisture is the root cause of mildew, soap scum, and musty odors. Good airflow is the cheapest and most effective shower maintenance tool. Make sure your exhaust fan actually vents to the outside and not just into the attic, which can cause moisture damage above the ceiling. Clean the fan cover every few months since dust buildup reduces its effectiveness dramatically." }
    ],
    proTips: [
